...
export default function Navbar() {
  ...
  return (
    <div
      className={cn(
        'fixed left-0 top-0 z-50 m-2 flex w-[calc(100vw_-_1rem)] p-2 text-xs sm:text-sm md:m-4 md:w-[calc(100vw_-_2rem)] md:p-4',
        {
    ...
    >
      <div className="relative flex w-full justify-between font-light text-black">
        ...
        <Link href="/">
          <h1 className="absolute left-2 top-1/2 -translate-y-1/2 text-xs font-black uppercase text-black mix-blend-overlay sm:text-sm">
            Kelvon Agee
          </h1>
        </Link>
        <div
          className="cursor-pointer text-xs font-black uppercase sm:text-sm "
